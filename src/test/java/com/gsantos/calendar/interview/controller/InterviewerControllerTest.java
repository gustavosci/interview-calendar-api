...
class InterviewerControllerTest {
    ...
    private static final String INTERVIEWER_RESOURCE = "/v1/interviewers";
    private static final String PATH_AVAILABILITY = INTERVIEWER_RESOURCE + "/availability";
    ...
    @MockBean
    private SetInterviewerAvailabilityService setInterviewerAvailabilityService;
    ...
    void shouldSetInterviewerAvailabilitySuccessfully() throws Exception {
        ...
        // Then
        then(setInterviewerAvailabilityService).should().set(username, request);
    }
    ...
    void shouldReturnBadRequestWhenSlotIsOverlapped() throws Exception {
        // Given
        var request = AvailabilityRequestBuilder.random();
        doThrow(new SlotOverlappedException("any")).when(setInterviewerAvailabilityService).set(any(), any());
        ...
        // Then
        then(setInterviewerAvailabilityService).should().set(any(), any());
    }
    ...
    void shouldReturnForbiddenWhenUserIsForbidden() throws Exception {
        // Given
        var request = AvailabilityRequestBuilder.random();
        doThrow(new ForbiddenUserException()).when(setInterviewerAvailabilityService).set(any(), any());
    ...
    void shouldReturnInternalServerErrorWhenAnyOtherErrorHappens() throws Exception {
        // Given
        var request = AvailabilityRequestBuilder.random();
        doThrow(new RuntimeException("kaboom")).when(setInterviewerAvailabilityService).set(any(), any());
    ...
    void shouldReturnBadRequestWhenMandatoryHeaderIsMissing() throws Exception {
        ...
        // Then
        then(setInterviewerAvailabilityService).should(never()).set(any(), any());
    }
